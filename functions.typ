...
#let consequence = (name: "Следствие", breakline: false, wording, proof)  => block_proofable(name, breakline, content, wording, proof)
#let property = (name: "Свойство", breakline: false, wording, proof)      => block_proofable(name, breakline, content, wording, proof)
